...
//        }
    ...
    private void setup() throws Exception{
        ...
        repo1 = new AggregateRepository(chronicleAES, Aggregate1.class, eventBus,chronicleEventFactory);
        repo2 = new AggregateRepository(chronicleAES, Aggregate2.class, eventBus, chronicleEventFactory);
    ...
    public void testCreateAndUpdateCommandDirect() throws Exception{
        ...
        for (int j = 0; j < REPEAT_TEST; j++) {
            ...
            rnd = createAggregates(rnd, ids, aggregates, 1000, true);
            rnd = createAggregates(rnd, ids, aggregates, 5000, false);

            updateAggregates(rnd, ids, 1000, true);
            updateAggregates(rnd, ids, 100000, false);
            watch.stop();
    ...
    private void updateAggregates(int rnd, List<MyId> ids, int iterations, boolean warmup) {
    ...
    private int createAggregates(int rnd, List<MyId> ids, List<Aggregate> aggregates, int iterations, boolean warmup) {
