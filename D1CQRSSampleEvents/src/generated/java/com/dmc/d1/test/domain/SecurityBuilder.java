...
public class SecurityBuilder implements StateEquals<Security> {
  ...
  public Security buildJournalable() {
    ...
    journalable.set(name,adv20Day);return journalable;
  }
  ...
  public Security buildImmutable() {
    ...
    if (immutable == null || !this.stateEquals(immutable)) {immutable = new SecurityImmutable(name,adv20Day);securityCache.put(name, immutable);}return immutable;
  }
