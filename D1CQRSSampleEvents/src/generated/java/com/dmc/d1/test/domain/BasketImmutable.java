...
class BasketImmutable implements Basket, Immutable {
  ...
  public BasketImmutable(String ric, LocalDate tradeDate, int divisor, Security security, List<BasketConstituent> basketConstituents, Map<String, BasketConstituent> basketConstituents2) {
    this.ric = ric;
  ...
  public boolean equals(Object o) {
    ...
    BasketImmutable that = (BasketImmutable)o;
